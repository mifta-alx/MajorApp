            ...
            <tbody>
                @foreach ($rankings as $ranking)
                    <tr>
                        ...
                        <td>{{ $ranking->result->nisn }}</td>
                        <td>{{ $ranking->student->student_name }}</td>
                        <td>{{ $ranking->school->school_name }}</td>
                        <td>{{ $ranking->result->saw_result }}</td>
                        <td>{{ $ranking->result->recomendation_result }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
