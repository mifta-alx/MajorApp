                ...
                <form wire:submit.prevent='store'>
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div class="sm:col-span-2">
                            <label for="alternative_name"
                                class="block mb-2 text-sm font-medium text-gray-900 @error('alternative_name') text-red-700 @enderror">Nama
                                Alternatif</label>
                            <input type="text" name="alternative_name" id="alternative_name"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-secondary-600 focus:border-secondary-600 block w-full p-2.5 @error('alternative_name') bg-red-50 border-red-500 text-red-900 placeholder-red-700 focus:ring-red-500 focus:border-red-500 @enderror"
