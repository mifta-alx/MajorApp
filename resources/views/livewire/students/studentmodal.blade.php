        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <form wire:submit.prevent='store'>
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div class="grid grid-cols-2">
                            <div
                                ...
                                <label for="inline-radio"
                                    class="ml-3 text-sm font-normal text-gray-900 @error('gender') text-red-600 @enderror">Laki
                                    -
                                    laki</label>
                            </div>
                            <div
                    ...
                    <div>
                        <label for="phone"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white @error('phone') text-red-700 @enderror">No,
                            Telepon</label>
                    ...
                    <div wire:ignore.self class="sm:col-span-2">
                        ...
                        <select id="npsn" wire:model="npsn" name="npsn"
                            ...
                            @forelse ($schools as $key => $value)
                                <option value="{{ $value->npsn }}"
                                    @if (old('npsn') == $value->npsn) selected @endif>{{ $value->school_name }}
                                </option>
                            @empty
